...
router.get('/', function (req, res) {
    console.log("in / acc_id; " + req.query.acc_id);
    accountDal.GetByID(req.query.acc_id, function (err, result) {
            if (err) throw err;

            res.render('displayAccountInfo.ejs', {rs: result, acc_id: req.query.acc_id});
        }
    );
});
